 ...
 * allelic dosages. The allelic dosages are in the BIMBAM dosage format. The 
...
// g++ genetic_score.bimbam.cpp -o grs -O2
// g++ genetic_score.bimbam.cpp -o grs -O2 -DNDEBUG

int main(int argc, char *argv[]) {

  if (argc != 4) {

    cerr << "Usage: " << argv[0] << " <N> <M> <beta file>" 
	 << endl; 
